...
public class FileNode extends BaseNode {
    ...
    public boolean equals(Object o) {
        ...
        // Compare modificationTime
        // NOTE: FAT32 has 2s precision on modification time - hence:
        //   * <5s difference in time is considered as equal
        //   * >5s difference is considered as not equal
        long diffInMillis = modificationTime.getTime() - fileNode.modificationTime.getTime();
